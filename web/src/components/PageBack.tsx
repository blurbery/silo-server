...
export default function PageBack({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={goBack}
      className={`glass detail-action-hover detail-action-hover-accent text-foreground ${position} z-20 flex items-center justify-center rounded-full p-1.5 shadow-md`}
    >

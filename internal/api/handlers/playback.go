...
// verifiedStreamCardFromRequest reuses a route-scoped transport capability
// already verified by middleware, then falls back to verifying the query token
// directly for callers mounted without that middleware.
